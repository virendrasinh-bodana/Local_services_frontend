                        ...
                        return(
                              ...
                              <option>{service.city}</option>
                                ...
                                <div class="col-lg-1 col-md-3 col-sm-12 p-0">
                                    <button type="submit" class="btn btn-base btn-danger" style={style1} >
              ...
              <div class="row">
                ...
                <div class="col-lg-4 align-self-center">
                  <ul>
                    ...
                    <li> Address <span>{service.area},{service.city} , {service.state}</span></li>
                ...
                <div class="col-lg-12">
                  <div class="main-button">
                    <Link to = "/browseservice" >Browse more</Link>
